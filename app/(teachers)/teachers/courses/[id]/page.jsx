...
export default function CourseStructureDesign() {
  ...
  // Approve script action (TA permission required)
                      ...
                      <div className="space-y-2">
                        ...
                        {unit.topics &&
                          unit.topics.map((topic, topicIndex) => {
                            ...
                            // Determine action button state based on status
                                  ...
                                  >
                                    ...
                                    <span>
                                      <IconButton
                                        ...
                                        disabled={topicStatus === "published" || (isScriptingDone && !canOverwrite)} // Prevent edit if published or scripting complete
                                      >
                                        <FileCheck />
                                      </IconButton>
                                    </span>
